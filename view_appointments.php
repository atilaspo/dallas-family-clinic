...
<body>
    <div class="dashboard-container">
        ...
        <div class="main-content">
            ...
            <form action="view_appointments.php" method="get" class="search-form">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>
                                ...
                                <td>
                                    <button class='btn btn-details' onclick='openDetailsModal(" . json_encode($row) . ")'>Details</button>
                                    <button class='btn btn-delete' onclick='deleteAppointment(" . $row["AppointmentID"] . ")'>Delete</button>
                                </td>
                            </tr>";
                        }
                    } else {
